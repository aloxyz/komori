...
(defun create-markov-table (stream)
  "Create markov table from stream."
...
(defun make-markov-from-stream (fname)
...
(defmacro make-markov-from-string (string)
 (make-markov-from-stream (make-string-input-stream string)))

(defmacro make-markov (fname)
 (with-open-file (stream fname)
  (make-markov-from-stream stream)))
